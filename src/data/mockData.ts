...
export const defectRecords: DefectRecord[] = [
  { id: "DF001", date: "2025-12-04", lineId: "L1", lineName: "本社-成形ライン1", productName: "電磁弁ユニット", defectType: "外観不良", defectCount: 2, totalCount: 200, defectRate: 1.0, note: "" },
  { id: "DF002", date: "2025-12-09", lineId: "L2", lineName: "本社-成形ライン2", productName: "注湯電磁弁", defectType: "寸法不良", defectCount: 3, totalCount: 180, defectRate: 1.67, note: "塗装ムラ" },
  { id: "DF003", date: "2025-12-11", lineId: "L3", lineName: "加古川-成形ライン1", productName: "ガス通路制御ユニット", defectType: "機能不良", defectCount: 1, totalCount: 150, defectRate: 0.67, note: "" },
  { id: "DF004", date: "2025-12-14", lineId: "L4", lineName: "加古川-成形ライン2", productName: "台所リモコン筐体", defectType: "その他", defectCount: 4, totalCount: 300, defectRate: 1.33, note: "バリ発生" },
  { id: "DF005", date: "2025-12-17", lineId: "L1", lineName: "本社-成形ライン1", productName: "電磁弁ユニット", defectType: "外観不良", defectCount: 1, totalCount: 200, defectRate: 0.5, note: "" },
  { id: "DF006", date: "2025-12-21", lineId: "L2", lineName: "本社-成形ライン2", productName: "注湯電磁弁", defectType: "寸法不良", defectCount: 2, totalCount: 180, defectRate: 1.11, note: "" },
  { id: "DF007", date: "2026-01-07", lineId: "L3", lineName: "加古川-成形ライン1", productName: "ガス通路制御ユニット", defectType: "外観不良", defectCount: 3, totalCount: 150, defectRate: 2.0, note: "治具調整必要" },
  { id: "DF008", date: "2026-01-09", lineId: "L4", lineName: "加古川-成形ライン2", productName: "台所リモコン筐体", defectType: "寸法不良", defectCount: 2, totalCount: 300, defectRate: 0.67, note: "" },
  { id: "DF009", date: "2026-01-12", lineId: "L1", lineName: "本社-成形ライン1", productName: "電磁弁ユニット", defectType: "機能不良", defectCount: 2, totalCount: 200, defectRate: 1.0, note: "" },
  { id: "DF010", date: "2026-01-16", lineId: "L2", lineName: "本社-成形ライン2", productName: "注湯電磁弁", defectType: "その他", defectCount: 1, totalCount: 180, defectRate: 0.56, note: "" },
  { id: "DF011", date: "2026-01-19", lineId: "L3", lineName: "加古川-成形ライン1", productName: "ガス通路制御ユニット", defectType: "寸法不良", defectCount: 2, totalCount: 150, defectRate: 1.33, note: "" },
  { id: "DF012", date: "2026-01-23", lineId: "L4", lineName: "加古川-成形ライン2", productName: "台所リモコン筐体", defectType: "外観不良", defectCount: 3, totalCount: 300, defectRate: 1.0, note: "" },
  { id: "DF013", date: "2026-02-04", lineId: "L1", lineName: "本社-成形ライン1", productName: "電磁弁ユニット", defectType: "外観不良", defectCount: 1, totalCount: 200, defectRate: 0.5, note: "" },
  { id: "DF014", date: "2026-02-06", lineId: "L2", lineName: "本社-成形ライン2", productName: "注湯電磁弁", defectType: "機能不良", defectCount: 2, totalCount: 180, defectRate: 1.11, note: "動作確認要" },
  { id: "DF015", date: "2026-02-11", lineId: "L3", lineName: "加古川-成形ライン1", productName: "ガス通路制御ユニット", defectType: "外観不良", defectCount: 1, totalCount: 150, defectRate: 0.67, note: "" },
  { id: "DF016", date: "2026-02-14", lineId: "L4", lineName: "加古川-成形ライン2", productName: "台所リモコン筐体", defectType: "その他", defectCount: 3, totalCount: 300, defectRate: 1.0, note: "" },
  { id: "DF017", date: "2026-02-18", lineId: "L1", lineName: "本社-成形ライン1", productName: "電磁弁ユニット", defectType: "外観不良", defectCount: 2, totalCount: 200, defectRate: 1.0, note: "" },
  { id: "DF018", date: "2026-02-21", lineId: "L2", lineName: "本社-成形ライン2", productName: "注湯電磁弁", defectType: "寸法不良", defectCount: 2, totalCount: 180, defectRate: 1.11, note: "" },
];

// ライン停止モックデータ（直近1ヶ月分 8件）
export const lineStoppages: LineStoppage[] = [
  { id: "LS001", date: "2026-02-03", lineId: "L1", lineName: "本社-成形ライン1", startTime: "09:15", endTime: "10:30", durationMinutes: 75, reason: "コンベア駆動モーター故障", category: "設備故障" },
  { id: "LS002", date: "2026-02-05", lineId: "L2", lineName: "本社-成形ライン2", startTime: "13:00", endTime: "13:45", durationMinutes: 45, reason: "部品在庫切れ（注湯電磁弁用シール材）", category: "資材不足" },
  { id: "LS003", date: "2026-02-07", lineId: "L3", lineName: "加古川-成形ライン1", startTime: "10:30", endTime: "11:00", durationMinutes: 30, reason: "不良品多発による緊急停止", category: "品質問題" },
  { id: "LS004", date: "2026-02-10", lineId: "L4", lineName: "加古川-成形ライン2", startTime: "14:00", endTime: "15:30", durationMinutes: 90, reason: "射出成形機ノズル詰まり", category: "設備故障" },
  { id: "LS005", date: "2026-02-13", lineId: "L1", lineName: "本社-成形ライン1", startTime: "08:30", endTime: "09:00", durationMinutes: 30, reason: "作業準備不足（工具紛失）", category: "その他" },
  { id: "LS006", date: "2026-02-17", lineId: "L2", lineName: "本社-成形ライン2", startTime: "11:15", endTime: "12:00", durationMinutes: 45, reason: "検査装置エラー、再キャリブレーション", category: "設備故障" },
  { id: "LS007", date: "2026-02-20", lineId: "L3", lineName: "加古川-成形ライン1", startTime: "15:00", endTime: "15:30", durationMinutes: 30, reason: "原材料（樹脂ペレット）在庫切れ", category: "資材不足" },
  { id: "LS008", date: "2026-02-24", lineId: "L4", lineName: "加古川-成形ライン2", startTime: "10:00", endTime: "11:30", durationMinutes: 90, reason: "寸法不良多発、金型調整", category: "品質問題" },
];
